...
const SvgSketchCopy = (props: SvgProps) => (
  <Svg
    ...
    fill="none"
    {...props}>
    <G clipPath="url(#sketch_copy_svg__a)">
      <Path
        fill="#F2F2F2"
        fillRule="evenodd"
        ...
        clipRule="evenodd"
      />
      <G filter="url(#sketch_copy_svg__b)">
        <Path
          fill="#EBEBEB"
    ...
    <Defs>
      <ClipPath id="sketch_copy_svg__a">
        <Path fill="#fff" d="M.5 0h177v177H.5z" />
      </ClipPath>
    </Defs>
  </Svg>
);
export default SvgSketchCopy;
